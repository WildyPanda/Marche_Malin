...
class ModifyPostDTO {
  ...
  ModifyPostDTO({required this.id, required this.title, required this.user, required this.images, required this.message, required this.tags, required this.categories});
